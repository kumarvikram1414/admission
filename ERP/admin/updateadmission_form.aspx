<%@  Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="updateadmission_form.aspx.cs" Inherits="admin_updateadmission_form" %>
            ...
            <div class="content-wrapper">
                <div class="row col-12 d-flex justify-content-center">
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-center mb-4"> Update Admission form</h4>

                               <!-- <form class="forms-sample">-->
                                 <asp:Label ID="lbladmission_form" runat="server" Text=""></asp:Label>
                                    <!--FormStart-->
                                <div class="col-20">
                                        <asp:Label ID="Label1" runat="server" Text="">Institute id</asp:Label>
                                        <div class="col-60">
